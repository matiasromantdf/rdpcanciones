            ...
            <div class="row mb-4" v-if="canInstall">
              <div class="col-12">
                ...
                <p class="text-muted mt-2">
                  Al instalar, podrás acceder a la aplicación desde tu escritorio o pantalla de inicio.
                </p>
              </div>
            </div>
                ...
                <div class="accordion" id="installInstructions">
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#chrome-desktop">
                        <i class="bi bi-browser-chrome me-2"></i>
                        Chrome/Edge - Windows/Mac
                      </button>
                    </h2>
                    <div id="chrome-desktop" class="accordion-collapse collapse" data-bs-parent="#installInstructions">
                      <div class="accordion-body">
                        <ol>
                          <li>Busca el ícono <i class="bi bi-download"></i> en la barra de direcciones</li>
                          <li>Haz clic en "Instalar RDP Canciones"</li>
                          <li>Confirma la instalación</li>
                        </ol>
                        <p><strong>Alternativa:</strong> Menú (⋮) > "Instalar RDP Canciones..."</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#chrome-mobile">
                        <i class="bi bi-phone me-2"></i>
                        Chrome - Android
                      </button>
                    </h2>
                    <div id="chrome-mobile" class="accordion-collapse collapse" data-bs-parent="#installInstructions">
                      <div class="accordion-body">
                        <ol>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#safari-ios">
                        <i class="bi bi-apple me-2"></i>
                        Safari - iPhone/iPad
                      </button>
                    </h2>
                    <div id="safari-ios" class="accordion-collapse collapse" data-bs-parent="#installInstructions">
                      <div class="accordion-body">
                        <ol>
                          <li>Toca el botón de compartir <i class="bi bi-box-arrow-up"></i></li>
